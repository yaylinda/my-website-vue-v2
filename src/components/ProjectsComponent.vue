        ...
        <md-card-expand-content>
          <md-card-content>
            ...
            <p>
              ...
              <a
                class="github-links"
                href="https://github.com/yaylinda/generic-backend"
                target="_blank"
              >backend API</a> and "game-engine" logic layer was written in Java, SpringBoot 2.0. Data for the game states
            ...
            <ul>
              <li>
                <a
                  class="github-links"
                  href="https://github.com/yaylinda/generic-frontend"
                  target="_blank"
                >Web-Client</a> -
              ...
              <li>
                <a
                  class="github-links"
                  href="https://github.com/yaylinda/simple_war_client"
                  target="_blank"
                >Mobile-Client</a> -
              ...
              <li>
                <a
                  class="github-links"
                  href="https://github.com/yaylinda/my-website-vue-v2/blob/master/src/views/SimpleWarView.vue"
                  target="_blank"
                >[CURRENT] Web-Client</a> -
                Rewrote the whole game UI in Vue, and incorporated it on this website!
              </li>
            </ul>
            <p>
              See
              <a href="/simple-war">"Simple War"</a> tab.
            </p>
          </md-card-content>
        </md-card-expand-content>
      </md-card-expand>
      ...
      <md-card-expand>
        ...
        <md-card-expand-content>
          <md-card-content>
            ...
            <ul>
              <li>
                <a href="https://github.com/yaylinda/my-life-data">my-life-data</a> - for data visualization projects pertaining to my life stats
              </li>
              <li>
                <a
                  href="https://github.com/yaylinda/data-visualization-projects"
                >data-visualization-projects</a> - for data visualization projects pertaining to any other stats
              </li>
            </ul>
            <p>
              See
              <a href="/data-viz">"Data Visualizations"</a> tab.
            </p>
          </md-card-content>
        </md-card-expand-content>
      </md-card-expand>
      ...
      <md-card-expand>
        ...
        <md-card-expand-content>
          <md-card-content>
            ...
            <p>
              See
              <a href="ecog.pdf" target="_blank">write-up.</a>
            </p>
          </md-card-content>
        </md-card-expand-content>
      </md-card-expand>
