<template>
  <div class="md-layout">
    ...
    <md-card class="md-layout-item md-medium-size-50 md-small-size-100">
      ...
      <md-card-actions>
        <md-button
          v-if="Object.keys(markerDataMap).indexOf(currentMarker.markerId) === 0"
          class="md-disabled"
          disabled
        >Previous</md-button>
        ...
        <md-button
          v-if="Object.keys(markerDataMap).indexOf(currentMarker.markerId) === Object.keys(markerDataMap).length - 1"
          class="md-disabled"
          disabled
        >Next</md-button>
...
export default class OverviewMapInfoCardComponent extends Vue {
  ...
  constructor() {
    ...
    this.markerDataMap.default = new MarkerData(
      'default',
      'top: 280px; left: 93px',
      new CardData(
        'Introduction',
    ...
    this.markerDataMap.childhood = new MarkerData(
      'childhood',
      'top: 203px; left: 137px;',
      new CardData(
        'Childhood',
        'Ages 0-18',
    ...
    this.markerDataMap.education = new MarkerData(
      'education',
      'top: 145px; left: 233px;',
      new CardData(
        'Education',
        'Rice University',
    ...
    this.markerDataMap.internships = new MarkerData(
      'internships',
      'top: 187px; left: 353px;',
      new CardData(
        'Internships',
    ...
    this.markerDataMap.capitalone = new MarkerData(
      'capitalone',
      'top: 161px; left: 433px;',
      new CardData(
        'Capital One',
        'First step into a full-time career',
